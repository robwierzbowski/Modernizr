...
// - min: Bool, whether to minify code. default: false
// - verbose: output msgs/errors, default false  // White noise suppression //// DOES NOTHING RIGHT NOW
// - callback: a callback to run at the end of the function. Has the var `code` available to it.
//// Metadata option here?, or do a separate function?
